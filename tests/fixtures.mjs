...
export function phantomView(angle) {
  const parts=[
    ...
    const width=128,height=192,span=.9,data=new Uint8Array(width*height);
...
export function phantomViews(){return Array.from({length:8},(_,index)=>phantomView(index*Math.PI/4));}
